...
export function LedgerViewer({ className }: LedgerViewerProps) {
  ...
  return (
    <div className={cn('flex flex-col h-full', className)}>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex items-center gap-1">
                      <button
                        ...
                        className="p-1.5 rounded-lg hover:bg-slate-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
      ...
      {/* Summary Bar */}
      <div className="mt-4 p-4 rounded-lg bg-slate-800/50 border border-slate-700 flex items-center justify-between">
