 ...
 *
 * Allows selection of multi-Cognate verification patterns:
 * - Sibling: Multiple Cognates work independently, compare results
 * - Debate: Cognates argue positions, reach consensus
 * - Family: Hierarchical with supervisor Cognate
...
const patterns: PatternConfig[] = [
  {
    ...
    name: 'Sibling',
    description:
      'Multiple Cognates work independently on the same task, then results are compared for consensus.',
    icon: Users,
    color: 'text-blue-400',
  ...
  },
  {
    ...
    name: 'Debate',
    description:
      'Cognates argue different positions and work through disagreements to reach a verified consensus.',
    icon: MessageSquare,
  ...
  },
  {
    ...
    name: 'Family',
    description:
      'A supervisor Cognate coordinates child Cognates and validates their outputs hierarchically.',
    icon: Network,
