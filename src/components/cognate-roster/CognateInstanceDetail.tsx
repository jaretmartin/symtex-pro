/**
 * Cognate Instance Detail Component
 *
 * Displays comprehensive information about a running Cognate instance
...
interface CognateInstanceDetailProps {
...
export default function CognateInstanceDetail({
  instance,
  template,
  executions = [],
  missionName,
  ...
  onRestart,
  onViewMission,
}: CognateInstanceDetailProps): JSX.Element {
