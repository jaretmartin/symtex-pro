  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
      <div className="bg-zinc-800 border border-zinc-700 rounded-xl p-4">
        ...
        <p className="text-2xl font-bold text-zinc-100">{stats.overallProgress}%</p>
      </div>
      <div className="bg-zinc-800 border border-zinc-700 rounded-xl p-4">
        <div className="flex items-center gap-2 mb-2">
          <Clock className="w-4 h-4 text-blue-400" />
          <span className="text-xs text-zinc-500">Hours Trained</span>
        </div>
        <p className="text-2xl font-bold text-zinc-100">{stats.totalHours.toFixed(1)}</p>
      </div>
      <div className="bg-zinc-800 border border-zinc-700 rounded-xl p-4">
        <div className="flex items-center gap-2 mb-2">
        ...
        <p className="text-2xl font-bold text-zinc-100">{stats.patternsLearned}</p>
      </div>
      <div className="bg-zinc-800 border border-zinc-700 rounded-xl p-4">
        <div className="flex items-center gap-2 mb-2">
        ...
        <p className="text-2xl font-bold text-zinc-100">{stats.totalSessions}</p>
      </div>
    </div>
  );
}
      ...
      <div className="flex items-center justify-between">
        <div>
          <div className="flex items-center gap-2 text-sm text-zinc-500 mb-1">
            <Link to="/studio/cognates" className="hover:text-zinc-300 flex items-center gap-1">
